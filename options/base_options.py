...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--dataloader', type=str, default='align', help='dataloader type')
        self.parser.add_argument('--activation', type=str, default='relu', help='activation type')
        # input/output sizes       
        ...
        self.parser.add_argument('--conv_layers', type=int, default=5, help='# of gen filters in first conv layer')
        self.parser.add_argument('--num_plane', type=int, default=3, help='# of gen filters in first conv layer')
        self.parser.add_argument('--num_quat', type=int, default=3, help='# of gen filters in first conv layer')
